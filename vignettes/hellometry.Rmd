...
impute missing body size and body mass measurements in the supplied data frame (or tibble). The package uses existing measurements in your data frame (tibble) to estimate the missing ones, so, essentially, the better the data supplied the better will be the estimations. Although originally developed for the Bromeliad Working Group (BWG) database, it is compatible with any kind of data, provided you follow a few simple rules of column naming. These are as follow: <br>
...
- column with development stage of specimens (larva/pupa/adult) needs to be called "stage" <br>
...
size_estimation_table_traits <- 
  full_estimation_table(level_vec  = c(), 
                        ...
                        trait_columns = trait_columns, ## vector of crisp trait columns
                        what = "size_col")
### See the output
...
model_estimation_table_traits <- 
  full_estimation_table(level_vec  = c(), 
                        measurement_table = dats, 
                        traits = T, ## traits = TRUE
                        trait_columns = trait_columns, ## vector of crip trait columns
                        what = "biomass_col")
### See the output
