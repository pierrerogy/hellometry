...
- column with development stage of specimens (larva/pupa/adult) needs to be called "abundance" (please only put adult for adult insects)<br>
...
## Just make sure to leave the bwg_name column empty before sending to hello_metry()
pitilla[112:117, 14] <- pitilla[112:117, 1]
