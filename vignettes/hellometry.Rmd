...
# - `size_estimations` - a tibble with all unique size estimations that were joined to your data
dplyr::glimpse(myreptiles_estimated$size_estimations)
# - `model_estimations` - a tibble with all unique allometric models that were joined to your data
...
### Note that the package keeps only models with 0 < R2 < 0.95 and p < 0.05, filtering out poorly-fit and overfitted models
...
## Get species
trait_lookup <-
  tibble::tibble(species = unique(measurement_table$species))
## Generate random set of traits
...
## Here you can see which species were grouped together
clean_trait_list <-
